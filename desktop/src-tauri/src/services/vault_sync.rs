...
pub(crate) fn faction_row_from_frontmatter(
    ...
    Ok(db::FactionRow {
        ...
        want: frontmatter.want.clone(),
        obstacle: frontmatter.obstacle.clone(),
        action: frontmatter.action.clone(),
        consequence: frontmatter.consequence.clone(),
        leader: frontmatter.leader.clone(),
        ...
        rivals_enemies: faction_list_to_db_text(&frontmatter.rivals_enemies)
            .map_err(|err| err.to_string())?,
        liege: frontmatter.liege.clone(),
        loyalty_type: frontmatter.loyalty_type.clone(),
        created_at: frontmatter.created_at.clone(),
        updated_at: frontmatter.updated_at.clone(),
    })
}
