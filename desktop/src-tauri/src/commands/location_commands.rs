...
pub async fn handle_location(invocation: DesktopHandlerInvocation<'_>) -> CommandResult {
    ...
    if lowered == "location help" {
        ...
        let help_doc = entity_help_doc(EntityKind::Location, &prose);
